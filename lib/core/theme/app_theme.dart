  ...
  static ThemeData get dark {
    return ThemeData(
      ...
      textTheme: GoogleFonts.poppinsTextTheme(ThemeData.dark().textTheme).copyWith(
        ...
        bodyMedium: GoogleFonts.dmSans(
          fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xFFB0B8C4),
        ),
      ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: GoogleFonts.dmSans(color: Color(0xFF6B7280), fontSize: 14),
        labelStyle: GoogleFonts.dmSans(color: Color(0xFF9CA3AF), fontSize: 14),
        errorStyle: GoogleFonts.dmSans(color: AppColors.error, fontSize: 12),
