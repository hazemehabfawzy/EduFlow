        ...
        child: Column(
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: AspectRatio(
                aspectRatio: 16 / 9,
                child: _CourseThumbnail(imageUrl: course.imageUrl),
              ),
            ),
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: _levelColor(course.level).withOpacity(0.12),
                          borderRadius: BorderRadius.circular(6),
                        ),
                        child: Text(
                          course.level,
...
/// Thumbnail with placeholder gradient and network image.
class _CourseThumbnail extends StatelessWidget {
  ...
  Widget _placeholder() {
    return Container(
      ...
      child: const Center(
        child: Icon(Icons.school_rounded, color: AppColors.white, size: 36),
      ),
    );
  }
}